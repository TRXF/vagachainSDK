...
describe('[19. chain Test]', () => {
	...
	it.skip('getTransactionByHash test', async () => {
		...
		// key: spender
		// value: vaga1jmg3kwy5hntx66nl93dyk2d92943394qsf6gcf
		//console.log("key: " + key);
