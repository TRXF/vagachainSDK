...
export class VagaGovService {

    constructor(private readonly config: VagaConfig) { }

    async getGasEstimationVote(wallet: VagaWalletService,
        proposalId: number,
        option: VotingOption,
    ...
    async getGasEstimationDeposit(wallet: VagaWalletService,
        proposalId: number,
        amount: number,
        txMisc: TxMisc = DefaultTxMisc): Promise<number> {
    ...
    async getGasEstimationSubmitCancelSoftwareUpgradeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
    ...
    async getGasEstimationSubmitSoftwareUpgradeProposalByHeight(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        upgradeName: string,
    ...
    async getGasEstimationSubmitParameterChangeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
    ...
    async getGasEstimationSubmitCommunityPoolSpendProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        amount: number,
    ...
    async getGasEstimationSubmitTextProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        txMisc: TxMisc = DefaultTxMisc): Promise<number> {
    ...
    private async getSignedTxSubmitTextProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        ...
        try {
            ...
            const sendAmount = { denom: this.config.denom, amount: VagaUtil.getUFCTStringFromFCT(initialDepositFCT) };
    ...
    private async getSignedTxSubmitCancelSoftwareUpgradeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        txMisc: TxMisc = DefaultTxMisc): Promise<TxRaw> {
        ...
        try {
            ...
            const initialDepositAmount = {
                ...
                amount: VagaUtil.getUFCTStringFromFCT(initialDepositFCT)
            };
    ...
    private async getSignedTxSubmitSoftwareUpgradeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
    ...
    private async getSignedTxSubmitParameterChangeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        paramList: ParamChangeOption[],
    ...
    private async getSignedTxSubmitCommunityPoolSpendProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDepositFCT: number,
        amount: number,
    ...
    async submitCancelSoftwareUpgradeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
    ...
    async submitSoftwareUpgradeProposalByHeight(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDeposit: number,
        upgradeName: string,
    ...
    async submitSoftwareUpgradeProposalByTime(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDeposit: number,
        upgradeName: string,
    ...
    async submitParameterChangeProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDeposit: number,
        paramList: ParamChangeOption[],
    ...
    async submitCommunityPoolSpendProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDeposit: number,
        amount: number,
    ...
    async submitTextProposal(wallet: VagaWalletService,
        title: string,
        description: string,
        initialDeposit: number,
        txMisc: TxMisc = DefaultTxMisc): Promise<BroadcastTxResponse> {
    ...
    private async getSignedTxVote(wallet: VagaWalletService,
        proposalId: Long,
        option: VotingOption,
        txMisc: TxMisc = DefaultTxMisc): Promise<TxRaw> {
    ...
    async vote(wallet: VagaWalletService, proposalId: number, option: VotingOption, txMisc: TxMisc = DefaultTxMisc):
    ...
    private async getSignedTxDeposit(wallet: VagaWalletService,
        proposalId: Long,
        amount: number,
        txMisc: TxMisc = DefaultTxMisc): Promise<TxRaw> {
    ...
    async deposit(wallet: VagaWalletService, proposalId: number, amount: number, txMisc: TxMisc = DefaultTxMisc):
        Promise<BroadcastTxResponse> {
        try {
